...
export class Rewards extends ethereum.SmartContract {
  ...
  isRewardDistribution(param0: Address): boolean {
    let result = super.call(
      "isRewardDistribution",
      "isRewardDistribution(address):(bool)",
  ...
  try_isRewardDistribution(param0: Address): ethereum.CallResult<boolean> {
...
export class SetRewardDistributionCall__Inputs {
  ...
  get _isRewardDistribution(): boolean {
