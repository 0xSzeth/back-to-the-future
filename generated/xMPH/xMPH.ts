...
export class xMPH extends ethereum.SmartContract {
  static bind(address: Address): xMPH {
    return new xMPH("xMPH", address);
  }
  ...
  currentUnlockEndTimestamp(): BigInt {
    let result = super.call(
      "currentUnlockEndTimestamp",
      "currentUnlockEndTimestamp():(uint256)",
      []
    );
  ...
  try_currentUnlockEndTimestamp(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "currentUnlockEndTimestamp",
      "currentUnlockEndTimestamp():(uint256)",
      []
  ...
  deposit(_mphAmount: BigInt): BigInt {
    let result = super.call("deposit", "deposit(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(_mphAmount)
    ]);

    return result[0].toBigInt();
  }

  try_deposit(_mphAmount: BigInt): ethereum.CallResult<BigInt> {
  ...
  rewardUnlockPeriod(): BigInt {
    let result = super.call(
      "rewardUnlockPeriod",
      "rewardUnlockPeriod():(uint256)",
      []
    );
  ...
  try_rewardUnlockPeriod(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "rewardUnlockPeriod",
      "rewardUnlockPeriod():(uint256)",
      []
  ...
  withdraw(_shareAmount: BigInt): BigInt {
    let result = super.call("withdraw", "withdraw(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(_shareAmount)
    ]);

    return result[0].toBigInt();
  }

  try_withdraw(_shareAmount: BigInt): ethereum.CallResult<BigInt> {
...
export class InitializeCall__Inputs {
  ...
  get _rewardUnlockPeriod(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }
...
export class SetRewardUnlockPeriodCall extends ethereum.Call {
  get inputs(): SetRewardUnlockPeriodCall__Inputs {
    return new SetRewardUnlockPeriodCall__Inputs(this);
  }

  get outputs(): SetRewardUnlockPeriodCall__Outputs {
    return new SetRewardUnlockPeriodCall__Outputs(this);
  }
}

export class SetRewardUnlockPeriodCall__Inputs {
  _call: SetRewardUnlockPeriodCall;

  constructor(call: SetRewardUnlockPeriodCall) {
    this._call = call;
  }
...
export class SetRewardUnlockPeriodCall__Outputs {
  _call: SetRewardUnlockPeriodCall;
