...
export class MPH extends ethereum.SmartContract {
  static bind(address: Address): MPH {
    return new MPH("MPH", address);
  }
  ...
  ownerMint(account: Address, amount: BigInt): boolean {
    let result = super.call("ownerMint", "ownerMint(address,uint256):(bool)", [
      ethereum.Value.fromAddress(account),
      ethereum.Value.fromUnsignedBigInt(amount)
    ]);
  ...
  try_ownerMint(
    ...
    let result = super.tryCall(
      "ownerMint",
      "ownerMint(address,uint256):(bool)",
      [
        ethereum.Value.fromAddress(account),
        ethereum.Value.fromUnsignedBigInt(amount)
      ]
