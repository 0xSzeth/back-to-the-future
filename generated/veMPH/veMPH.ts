...
export class veMPH__lockedResult {
  value0: BigInt;
  value1: BigInt;
...
export class veMPH__point_historyResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class veMPH__user_point_historyResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class veMPH extends ethereum.SmartContract {
  static bind(address: Address): veMPH {
    return new veMPH("veMPH", address);
  }
  ...
  locked(arg0: Address): veMPH__lockedResult {
    let result = super.call("locked", "locked(address):(int128,uint256)", [
      ethereum.Value.fromAddress(arg0)
    ]);

    return new veMPH__lockedResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_locked(arg0: Address): ethereum.CallResult<veMPH__lockedResult> {
    ...
    return ethereum.CallResult.fromValue(
      new veMPH__lockedResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  point_history(arg0: BigInt): veMPH__point_historyResult {
    let result = super.call(
      "point_history",
    ...
    return new veMPH__point_historyResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_point_history(
    arg0: BigInt
  ): ethereum.CallResult<veMPH__point_historyResult> {
    let result = super.tryCall(
      "point_history",
      "point_history(uint256):(int128,int128,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(arg0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new veMPH__point_historyResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  user_point_history(
    arg0: Address,
    arg1: BigInt
  ): veMPH__user_point_historyResult {
    let result = super.call(
      "user_point_history",
    ...
    return new veMPH__user_point_historyResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_user_point_history(
    arg0: Address,
    arg1: BigInt
  ): ethereum.CallResult<veMPH__user_point_historyResult> {
    let result = super.tryCall(
      "user_point_history",
      "user_point_history(address,uint256):(int128,int128,uint256,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new veMPH__user_point_historyResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
