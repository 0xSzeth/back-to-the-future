...
export class SetRewardDistributor extends ethereum.Event {
  get params(): SetRewardDistributor__Params {
    return new SetRewardDistributor__Params(this);
  }
}

export class SetRewardDistributor__Params {
  _event: SetRewardDistributor;

  constructor(event: SetRewardDistributor) {
    this._event = event;
  }
...
export class UpdateDuration extends ethereum.Event {
  get params(): UpdateDuration__Params {
    return new UpdateDuration__Params(this);
  }
}

export class UpdateDuration__Params {
  _event: UpdateDuration;

  constructor(event: UpdateDuration) {
    this._event = event;
  }
...
export class Vesting03__getVestResultValue0Struct extends ethereum.Tuple {
  get pool(): Address {
...
export class Vesting03__periodInfoResult {
  value0: BigInt;
  value1: BigInt;
...
export class Vesting03__vestListResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Vesting03 extends ethereum.SmartContract {
  static bind(address: Address): Vesting03 {
    return new Vesting03("Vesting03", address);
  }
  ...
  forwarderOfPool(pool: Address): Address {
    let result = super.call(
      "forwarderOfPool",
      "forwarderOfPool(address):(address)",
      [ethereum.Value.fromAddress(pool)]
    );
  ...
  try_forwarderOfPool(pool: Address): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "forwarderOfPool",
      "forwarderOfPool(address):(address)",
      [ethereum.Value.fromAddress(pool)]
  ...
  try_forwarderTemplate(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "forwarderTemplate",
      "forwarderTemplate():(address)",
      []
  ...
  getVest(vestID: BigInt): Vesting03__getVestResultValue0Struct {
    let result = super.call(
      "getVest",
    ...
    return changetype<Vesting03__getVestResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getVest(
    vestID: BigInt
  ): ethereum.CallResult<Vesting03__getVestResultValue0Struct> {
    let result = super.tryCall(
      "getVest",
      "getVest(uint64):((address,uint64,uint64,uint256,uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(vestID)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<Vesting03__getVestResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  isRewardDistributor(param0: Address): boolean {
    let result = super.call(
      "isRewardDistributor",
      "isRewardDistributor(address):(bool)",
      [ethereum.Value.fromAddress(param0)]
    );
  ...
  try_isRewardDistributor(param0: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "isRewardDistributor",
      "isRewardDistributor(address):(bool)",
      [ethereum.Value.fromAddress(param0)]
  ...
  lastTimeRewardApplicable(pool: Address): BigInt {
    let result = super.call(
      "lastTimeRewardApplicable",
      "lastTimeRewardApplicable(address):(uint64)",
      [ethereum.Value.fromAddress(pool)]
    );
  ...
  try_lastTimeRewardApplicable(pool: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "lastTimeRewardApplicable",
      "lastTimeRewardApplicable(address):(uint64)",
      [ethereum.Value.fromAddress(pool)]
  ...
  periodInfo(param0: Address): Vesting03__periodInfoResult {
    let result = super.call(
      "periodInfo",
      "periodInfo(address):(uint64,uint64)",
      [ethereum.Value.fromAddress(param0)]
    );

    return new Vesting03__periodInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_periodInfo(
    param0: Address
  ): ethereum.CallResult<Vesting03__periodInfoResult> {
    let result = super.tryCall(
      "periodInfo",
      "periodInfo(address):(uint64,uint64)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Vesting03__periodInfoResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

  rewardPerToken(pool: Address): BigInt {
    let result = super.call(
      "rewardPerToken",
  ...
  try_rewardPerToken(pool: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "rewardPerToken",
      "rewardPerToken(address):(uint256)",
      [ethereum.Value.fromAddress(pool)]
  ...
  rewards(param0: BigInt): BigInt {
    let result = super.call("rewards", "rewards(uint64):(uint256)", [
  ...
  try_rewards(param0: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("rewards", "rewards(uint64):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  totalDepositStored(param0: Address): BigInt {
    let result = super.call(
      "totalDepositStored",
      "totalDepositStored(address):(uint256)",
      [ethereum.Value.fromAddress(param0)]
    );
  ...
  try_totalDepositStored(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "totalDepositStored",
      "totalDepositStored(address):(uint256)",
      [ethereum.Value.fromAddress(param0)]
  ...
  vestList(param0: BigInt): Vesting03__vestListResult {
    let result = super.call(
      "vestList",
    ...
    return new Vesting03__vestListResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_vestList(param0: BigInt): ethereum.CallResult<Vesting03__vestListResult> {
    let result = super.tryCall(
      "vestList",
      "vestList(uint256):(address,uint64,uint64,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  vestRewardPerTokenPaid(param0: BigInt): BigInt {
    let result = super.call(
      "vestRewardPerTokenPaid",
      "vestRewardPerTokenPaid(uint64):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
  ...
  try_vestRewardPerTokenPaid(param0: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "vestRewardPerTokenPaid",
      "vestRewardPerTokenPaid(uint64):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
...
export class ConstructorCall__Inputs {
  ...
  get forwarderTemplate_(): Address {
...
export class DeployForwarderOfPoolCall extends ethereum.Call {
  get inputs(): DeployForwarderOfPoolCall__Inputs {
    return new DeployForwarderOfPoolCall__Inputs(this);
  }

  get outputs(): DeployForwarderOfPoolCall__Outputs {
    return new DeployForwarderOfPoolCall__Outputs(this);
  }
}

export class DeployForwarderOfPoolCall__Inputs {
  _call: DeployForwarderOfPoolCall;

  constructor(call: DeployForwarderOfPoolCall) {
    this._call = call;
  }
...
export class DeployForwarderOfPoolCall__Outputs {
  _call: DeployForwarderOfPoolCall;
...
export class SetRewardDistributorCall__Inputs {
  ...
  get isRewardDistributor_(): boolean {
    return this._call.inputValues[1].value.toBoolean();
  }
}
...
export class UpdateDurationCall extends ethereum.Call {
  get inputs(): UpdateDurationCall__Inputs {
    return new UpdateDurationCall__Inputs(this);
  }

  get outputs(): UpdateDurationCall__Outputs {
    return new UpdateDurationCall__Outputs(this);
  }
}

export class UpdateDurationCall__Inputs {
  _call: UpdateDurationCall;

  constructor(call: UpdateDurationCall) {
    this._call = call;
  }
...
export class UpdateDurationCall__Outputs {
  _call: UpdateDurationCall;
